...
void test_bmp(char *img_name) {
    ...
    img = load_bmp("assets/0_64.bmp");
    templates[0] = img.data;
    img = load_bmp("assets/1_64.bmp");
    templates[1] = img.data;
    img = load_bmp("assets/2_64.bmp");
    templates[2] = img.data;
    img = load_bmp("assets/3_64.bmp");
    templates[3] = img.data;
    img = load_bmp("assets/4_64.bmp");
    templates[4] = img.data;
    img = load_bmp("assets/5_64.bmp");
    templates[5] = img.data;
    img = load_bmp("assets/6_64.bmp");
    templates[6] = img.data;
    img = load_bmp("assets/7_64.bmp");
    templates[7] = img.data;
    img = load_bmp("assets/8_64.bmp");
    templates[8] = img.data;
    img = load_bmp("assets/9_64.bmp");
